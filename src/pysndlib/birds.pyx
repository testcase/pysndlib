#==================================================================================
# The code is from Rick Taube's faithful translation of Bill Schottstedaet's 'bird.scm' 
...
def bird(start, dur, frequency, freqskew, amplitude, freq_envelope, amp_envelope):
    ...
    beg: cython.long = clm.seconds2samples(start) # in for loop
    end: cython.long = clm.seconds2samples(start + dur) # in for loop
